...
public class FormatTagTest {
    ...
    public void dayOfWeekTest() throws IOException, JspException {
        assertEquals("dl. dl. dl. dilluns 1 01 dl. dilluns", format(
            DayOfWeek.MONDAY, "E EE EEE EEEE e ee eee eeee", null));
        assertEquals("dt. dt. dt. dimarts 2 02 dt. dimarts", format(
            DayOfWeek.TUESDAY, "E EE EEE EEEE e ee eee eeee", null));
    }
    ...
    public void instantTest() throws JspException, IOException {
        ...
        assertEquals("divendres, 6 / de novembre / 2015",
                     format(instant, null, "F-"));
    ...
    public void localDateTimeTest() throws IOException, JspException {
        ...
        assertEquals("06/11/2015 10:55:53",
                     format(localDateTime, "dd/MM/yyyy HH:mm:ss", null));
    ...
    public void monthTest() throws IOException, JspException {
        assertEquals("4 04 d’abr. d’abril 4 04 abr. abril",
                     format(Month.APRIL, "M MM MMM MMMM L LL LLL LLLL", null));
    }
    ...
    public void offsetDateTimeTest() throws IOException, JspException {
        ...
        assertEquals("6 / de novembre / 2015",
                     format(offsetDateTime, null, "L-"));
        assertEquals("divendres, 6 / de novembre / 2015",
                     format(offsetDateTime, null, "F-"));
    ...
    public void yearTest() throws IOException, JspException {
        ...
        assertEquals("2015 15 2015 2015 2015 15 2015 2015 dC dC dC AD", format(
            year, "u uu uuu uuuu y yy yyyy yyyy G GG GGG GGGG", null));
    }

    @Test
    public void yearMonthTest() throws IOException, JspException {
        YearMonth yearMonth = YearMonth.parse("2015-11");
        assertEquals("dC 2015 2015 11 11 4 04 4T 4t trimestre", format(
            yearMonth, "G u y M L Q QQ QQQ QQQQ", null));
    }
    ...
    public void zonedDateTime() throws IOException, JspException {
        ...
        assertEquals("6 / de novembre / 2015",
                     format(pstZonedDateTime, null, "L-"));
        assertEquals("divendres, 6 / de novembre / 2015",
                     format(pstZonedDateTime, null, "F-"));
